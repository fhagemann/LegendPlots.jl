...
function lplot(chinfo::Table, pars::PropDict, properties::AbstractVector{Symbol}; legend_logo  = true, juleana_logo = true)
    ...
    axmain = Axis(fig,
        ...
        xticklabelfont = "Roboto", 
        yticklabelfont = "Roboto",
        xlabelfont = "Roboto",
        ylabelfont = "Roboto",
        yticklabelsize = 14,
        xlabelsize = 20,
    ...
    if legend_logo
        ...
        Makie.text!(ax_legend, legend_suffix, position = (0.11,0.83), color = DeepCove, fontsize = 22, font = "Roboto", rotation = 270u"°", space = :relative)   
    end
